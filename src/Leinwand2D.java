...
public class Leinwand2D extends JPanel {
	...
	private Dimension paintableDimension = new Dimension(500, 500); // square dimension where we can paint on
...
//		}
		...
		drawFunctions(g); // Select which function to plot here
...
//				} // TODO: remove?
	...
	private void drawFunctions(Graphics g) {
		...
		if (transformedFunctionOutputPoints != null) {
...
//				System.out.println("DRAWFUNCTIONS: \t drawing transformed function " + i);
